...
import { getContestDetailEdit } from './contest/getDetailEdit.service';
 ...
 * @param 없음
 */
export const ContestService = { regContest, getContestDetail, getContestList, modContest, delContest, getContestDetailEdit };
